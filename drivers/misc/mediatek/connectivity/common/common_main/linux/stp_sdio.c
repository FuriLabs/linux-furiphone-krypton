			   ...
			   loff_t *f_pos)
{
	...
	if (x == 0) {
		...
		STPSDIO_PR_DBG("set STP-SDIO LogLevel to STPSDIO_LOG_INFO\n\r");
	} else if (x == 5) {
		gStpSdioDbgLvl = STPSDIO_LOG_HINT;
		STPSDIO_PR_DBG("set STP-SDIO LogLevel to STPSDIO_LOG_HINT\n\r");
	} else if (x == 6) {
		gStpSdioDbgLvl = STPSDIO_LOG_DBG;
		STPSDIO_PR_DBG("set STP-SDIO LogLevel to STPSDIO_LOG_DBG\n\r");
	} else if (x == 7) {
		gStpSdioDbgLvl = STPSDIO_LOG_LOUD;
		STPSDIO_PR_DBG("set STP-SDIO LogLevel to STPSDIO_LOG_LOUD\n\r");
	}
