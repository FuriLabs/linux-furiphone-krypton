...
/* audio debug log */
static const char * const mt6873_afe_off_on_str[] = {
	"Off", "On"
};

static int mt6873_afe_debug_get(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	return 0;
}

static int mt6873_afe_debug_set(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct soc_enum mt6873_afe_misc_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6873_afe_off_on_str),
			    mt6873_afe_off_on_str),
};

static const struct snd_kcontrol_new mt6873_afe_debug_controls[] = {
	SOC_ENUM_EXT("Audio_Debug_Setting", mt6873_afe_misc_enum[0],
		     mt6873_afe_debug_get, mt6873_afe_debug_set),
};
...
static int mt6873_afe_vow_bargein_set(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
#if defined(CONFIG_MTK_VOW_SUPPORT)
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
...
static const struct snd_kcontrol_new mt6873_afe_bargein_controls[] = {
...
int mt6873_add_misc_control(struct snd_soc_component *component)
{
	...
	snd_soc_add_component_controls(component,
				      mt6873_afe_debug_controls,
				      ARRAY_SIZE(mt6873_afe_debug_controls));
